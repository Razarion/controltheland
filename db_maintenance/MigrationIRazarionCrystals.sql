...
-- Inventory
ALTER TABLE INVENTORY_ARTIFACT CHANGE COLUMN `razarionCoast` `crystalCost` INT(11) NULL DEFAULT NULL  ;
ALTER TABLE INVENTORY_ITEM CHANGE COLUMN `razarionCoast` `crystalCost` INT(11) NULL DEFAULT NULL  ;
