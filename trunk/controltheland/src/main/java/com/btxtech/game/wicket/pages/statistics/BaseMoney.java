 ...
 * Time: 2:18:47 PM
 */
public class BaseMoney extends Panel {
    @SpringBean
    private StatisticsService statisticsService;

    public BaseMoney(int count) {
        super("baseMoney");
        DataView<BaseStatisticsDTO> tileList = new DataView<BaseStatisticsDTO>("table", new BaseDataProvider(statisticsService, count, BaseDataProvider.Type.MONEY)) {
            ...
            protected void populateItem(Item<BaseStatisticsDTO> baseItem) {
                ...
                baseItem.add(new Label("money", baseItem.getModelObject().getData()));
