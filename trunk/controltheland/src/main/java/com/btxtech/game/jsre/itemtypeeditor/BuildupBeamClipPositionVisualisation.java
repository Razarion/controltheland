...
public class BuildupBeamClipPositionVisualisation extends AbstractVisualisation {
    private static final int CROSS_SIDE_LENGTH = 5;

    public BuildupBeamClipPositionVisualisation(final BuildupBeamPanel buildupBeamPanel) {
        ...
        getCanvas().addMouseDownHandler(new MouseDownHandler() {
            ...
            public void onMouseDown(MouseDownEvent event) {
                ...
                ItemTypeEditorModel.getInstance().setCurrentBuildupClipPosition(clipPosition);
                buildupBeamPanel.onModelUpdate();
            }
        });
    }
