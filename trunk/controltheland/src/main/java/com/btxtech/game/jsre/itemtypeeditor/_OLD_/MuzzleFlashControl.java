...
public class MuzzleFlashControl extends DecoratorPanel {
    ...
    private void setTargetPosition() {
        // TODO double angel = syncBaseItem.getSyncItemArea().createBoundingBox().imageNumberToAngel(imageNr);
        // TODO Index targetPos = syncBaseItem.getSyncItemArea().getPosition().getPointFromAngelToNord(angel, (weaponType.getRange() + syncBaseItem.getSyncItemArea().createBoundingBox().getHeight()) * 0.9);
        // TODO targetPos = Index.createSaveIndex(targetPos);
        // TODO target.getSyncItemArea().setPosition(targetPos);
    }
