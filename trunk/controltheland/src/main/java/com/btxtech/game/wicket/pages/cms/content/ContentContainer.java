...
public class ContentContainer extends Panel {
    ...
    public ContentContainer(String id, DbContentContainer dbContentContainer, final BeanIdPathElement beanIdPathElement) {
        super(id);
    ...
    private void setupContainer(DbContentContainer dbContentContainer) {
        ...
        for (DbContent dbContent : dbContentContainer.getContentCrud().readDbChildren()) {
            ...
            view.add(cmsUiService.getComponent(dbContent, bean, view.newChildId(), childBeanIdPathElement));
        }
        add(view);
    }
