...
public class BuildupStepEditorPanel extends DecoratorPanel {
    ...
    private void setupBaseItemType(BaseItemType baseItemType, final ItemTypeSimulation itemTypeSimulation) {
        // TODO if (baseItemType.getBuildupStep() != null) {
        // TODO     buildupSteps = baseItemType.getBuildupStep();
        // TODO } else {
        // TODO     buildupSteps = new ArrayList<BuildupStep>();
        // TODO     baseItemType.setBuildupStep(buildupSteps);
        // TODO }
    ...
    private void onImageDropped(String imageData) {
        // TODO BuildupStep buildupStep = new BuildupStep(imageData);
        // TODO buildupSteps.add(buildupStep);
    ...
    private void drawTable() {
        ...
        if (buildupSteps.isEmpty()) {
            ...
            for (int i = 0; i < buildupSteps.size(); i++) {
                ...
                // TODO if (buildupStep.getBase64ImageData() != null) {
                // TODO     flexTable.setWidget(newRowNumber, 0, new Image(buildupStep.getBase64ImageData()));
                // TODO } else {
                // TODO     flexTable.setWidget(newRowNumber, 0, new Image(ImageHandler.getBuildupStepImageUrl(baseItemType, buildupStep)));
                // TODO }
    ...
    private native void handleDroppedData(DataTransfer dataTransfer)  /*-{
        for (var i = 0; i < dataTransfer.files.length; i++) {
            ...
            reader.onload = (function (theFile) {
                return function (e) {
                    // Render thumbnail.
                    $entry(@com.btxtech.game.jsre.itemtypeeditor._OLD_.BuildupStepEditorPanel::onStaticImageDropped(Ljava/lang/String;)(e.target.result));
                };
            })(file);
