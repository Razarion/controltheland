...
//        final CrudRootTableHelper<DbLevel> tableHelper = new CrudRootTableHelper<DbLevel>("levels", "save", null, true, copyRadioGroup, true) {
//
//            @Override
...
//
//            @Override
//            protected void onEditSubmit(DbLevel dbAbstractLevel) {
