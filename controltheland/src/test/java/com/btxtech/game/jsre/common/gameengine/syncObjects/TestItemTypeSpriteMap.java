...
public class TestItemTypeSpriteMap {
    ...
    public void testDemolitionStep1() {
        ...
        ItemTypeSpriteMap itemTypeSpriteMap = new ItemTypeSpriteMap(boundingBox, 100, 200, 4, 3, 25, 5, 30, new DemolitionStepSpriteMap[]{new DemolitionStepSpriteMap(1, 100, null), new DemolitionStepSpriteMap(3, 200, null)});
    ...
    public void testDemolitionStep1NoImages() {
        BoundingBox boundingBox = new BoundingBox(80, new double[]{0.0, 0.1, 0.2, 0.3, 0.4});
        ItemTypeSpriteMap itemTypeSpriteMap = new ItemTypeSpriteMap(boundingBox, 100, 200, 4, 3, 25, 4, 30, new DemolitionStepSpriteMap[]{new DemolitionStepSpriteMap(0, 0, null), new DemolitionStepSpriteMap(0, 0, null)});
    ...
    public void testDemolitionStep2NoImages() {
        BoundingBox boundingBox = new BoundingBox(80, new double[]{0.0, 0.1, 0.2, 0.3});
        ItemTypeSpriteMap itemTypeSpriteMap = new ItemTypeSpriteMap(boundingBox, 100, 200, 4, 3, 25, 5, 30, new DemolitionStepSpriteMap[]{new DemolitionStepSpriteMap(1, 100, null), new DemolitionStepSpriteMap(0, 0, null)});
