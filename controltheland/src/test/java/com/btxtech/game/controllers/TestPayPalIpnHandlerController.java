...
public class TestPayPalIpnHandlerController {
    ...
    public void normal() throws Exception {
        ...
        financeServiceMock.crystalsBoughtViaPaypal("00001", "RAZ1000", "5.00", "USD", "11112222", "hallo@cxyyyy.qqq", "wwwww@qqqqq.sssss", "Completed", "1");
    ...
    public void transactionAlreadyProcessed() throws Exception {
        ...
        FinanceService financeServiceMock = EasyMock.createStrictMock(FinanceService.class);
        financeServiceMock.crystalsBoughtViaPaypal(null, null, null, null, null, null, null, null, null);
