...
//        SimpleBase unregKillBase = ((RealGameInfo) movableService.getGameInfo()).getBase();
//        endHttpRequestAndOpenSessionInViewFilter();
//        endHttpSession();
//
...
//        movableService.getGameInfo();
//        movableService.sendTutorialProgress(TutorialConfig.TYPE.TUTORIAL, "", "", 0, 0);
//        SimpleBase u2Base = ((RealGameInfo) movableService.getGameInfo()).getBase();
...
//        movableService.getGameInfo();
//        movableService.sendTutorialProgress(TutorialConfig.TYPE.TUTORIAL, "", "", 0, 0);
//        SimpleBase realUser = ((RealGameInfo) movableService.getGameInfo()).getBase();
//        Index buildPos = collisionService.getFreeRandomPosition(itemService.getItemType(TEST_FACTORY_ITEM_ID), new Rectangle(0, 0, 100000, 100000), 400, true, false);
...
//        beginHttpRequestAndOpenSessionInViewFilter();
//        userService.login("U1", "test");
//        realUser = ((RealGameInfo) movableService.getGameInfo()).getBase();
...
//            Assert.assertEquals(oldUserState.getDbLevel(), newUserState.getDbLevel());
//            Assert.assertEquals(oldUserState.getDbLevel().getLevel(), newUserState.getDbLevel().getLevel());
