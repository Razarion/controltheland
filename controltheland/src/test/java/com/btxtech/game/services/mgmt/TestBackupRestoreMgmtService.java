...
public class TestBackupRestoreMgmtService extends AbstractServiceTest {
    ...
    @Test
    @DirtiesContext
    public void levelTaskDone() throws Exception {
        configureGameMultipleLevel();
