...
public class TestMovableServiceTerrain extends AbstractServiceTest {
    ...
    @Test
    public void testRealGame() throws LevelActivationException, InvalidLevelStateException {
        // Setup clip
        beginHttpSession();
        ...
        // Test surface images
        Assert.assertEquals(2, realGameInfo.getSurfaceImages().size());
        assertSurfaceImage(realGameInfo.getSurfaceImages(), dbSurfaceImage1.getId(), dbImageSpriteMap1.getId(), "back1", SurfaceType.LAND);
        assertSurfaceImage(realGameInfo.getSurfaceImages(), dbSurfaceImage2.getId(), null, "back2", SurfaceType.WATER);
        // Test terrain images
    ...
    private void assertSurfaceImage(Collection<SurfaceImage> surfaceImages, int id, Integer imageSpriteMapId, String htmlBackgroundColor, SurfaceType surfaceType) {
