 ...
 * Time: 2:18:47 PM
 */
public class BaseKills extends Panel {
    @SpringBean
    private StatisticsService statisticsService;

    public BaseKills(int count) {
        super("baseKills");
        DataView<BaseStatisticsDTO> tileList = new DataView<BaseStatisticsDTO>("table", new BaseDataProvider(statisticsService, count, BaseDataProvider.Type.KILLS)) {
            ...
            protected void populateItem(Item<BaseStatisticsDTO> baseItem) {
                ...
                baseItem.add(new Label("kills", baseItem.getModelObject().getData()));
