 ...
 * Time: 2:18:47 PM
 */
public class BaseSize extends Panel {
    @SpringBean
    private StatisticsService statisticsService;

    public BaseSize(int count) {
        super("baseSize");
        DataView<BaseStatisticsDTO> tileList = new DataView<BaseStatisticsDTO>("table", new BaseDataProvider(statisticsService, count, BaseDataProvider.Type.SIZE)) {
