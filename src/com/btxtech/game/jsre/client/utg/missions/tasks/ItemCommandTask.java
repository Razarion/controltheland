...
public class ItemCommandTask extends Task {
    ...
    private boolean awaitIdle = false;

    public ItemCommandTask(String html, String targetItemTypeName, Class<? extends BaseCommand> commandClass, boolean awaitIdle) throws NoSuchItemTypeException {
        super(html);
        this.commandClass = commandClass;
        this.awaitIdle = awaitIdle;
    ...
    public boolean isCommandFulfilled() {
        return commandReceived;
    }

    public boolean isCommandAccepted(BaseCommand baseCommand) {
        return baseCommand.getClass().equals(commandClass);
    }

    public void setCommandAccepted() {
